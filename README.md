...
- wave 17: `7` additional Pension Credit official `regulation 9` qualifying-income exclusion leaves promoted from the clean committed seed suite
- wave 18: `55` additional Pension Credit official `regulation 15` leaves promoted from the clean committed bulk seed suite, with `15(1)(b)` and `15(1)(c)` confirmed by a clean reviewer-transport rerun
- current total: `146` `.rac` files with companion tests
...
- [waves/2026-04-01-wave17/manifest.json](/Users/maxghenis/TheAxiomFoundation/rac-uk/waves/2026-04-01-wave17/manifest.json)
- [waves/2026-04-08-wave18/manifest.json](/Users/maxghenis/TheAxiomFoundation/rac-uk/waves/2026-04-08-wave18/manifest.json)
